...
Location::Location(string path, string root, string index, string autoindex, string body_limit, bool is_cgi, string cgi_extension, bool is_redirect, string redirect)
{
	_path = path;
	_root = root;
	_index = index;
...
string Location::get_body_limit() const { return _body_limit; }
...
void Location::set_body_limit(string body_limit) { _body_limit = body_limit; }
